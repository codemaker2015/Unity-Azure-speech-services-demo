...
* This sample is targeted for Unity 2019.4 or later. To install, pick an appropriate option in the [Unity store](https://store.unity.com/).
  > Note:
...
* Check that under **Other Settings**, `Microphone usage description` has a description entered.
  > Note: Some iOS configurations may require the checkbox `Prepare iOS for recording` to be enabled to allow microphone input on device.
